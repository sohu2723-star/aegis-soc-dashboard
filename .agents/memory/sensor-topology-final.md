...
|---|---|---|---|
| bank-web | 10.10.10.10 | fail2ban, ssh, http (modsecurity) | fail2ban, ssh, apache2 |
| customer-db | 10.20.20.10 | fail2ban, ssh, mysql | fail2ban, ssh, mysql |
| dns-server | 10.10.10.20 | fail2ban, ssh, bind9 | fail2ban, ssh, named |
| ldap-server | 10.20.20.20 | fail2ban, ssh, slapd | fail2ban, ssh, slapd |
...
- **PostgreSQL Monitor** (customer-db) — replaced by MySQL Monitor
- **ATM API Monitor** (10.20.20.20) — replaced by LDAP Monitor (ldap-server/slapd)
