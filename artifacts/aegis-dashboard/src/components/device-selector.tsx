...
const roleLabels: Record<string, string> = {
  ubuntu: "DEFENDER", router: "ROUTER", pfsense: "INFRASTRUCTURE", unknown: "UNKNOWN",
  "web-server": "WEB SERVER", workstation: "WORKSTATION", database: "DATABASE", forwarder: "FORWARDER",
};
